...
const qnaList = [
  {
    q: '새를 관찰한 서식지는 어디였나요?',
    a: [
      { answer: '도시', type: ['1', '2', '4', '9'] },
      { answer: '바다', type: ['0', '3', '6', '5', '10', '8'] },
      { answer: '습지', type: ['7', '11' ] },
    ]
  },
  {
    q: '새의 크기는 어땠나요?',
    a: [
      { answer: '참새', type: ['0', '3', '2', '8'] },
      { answer: '직박구리', type: ['1', '6', '5', '10'] },
      { answer: '비둘기', type: ['7', '4', '9', '11'] },
      { answer: '까마귀', type: ['7', '4', '9', '11'] },
      { answer: '거위', type: ['7', '4', '9', '11'] },
      { answer: '독수리', type: ['7', '4', '9', '11'] },
    ]
  },
  {
    q: '거의 다 왔어요! 새의 부리 모양은 어땠나요?',
    a: [
      { answer: '작고 세모난 부리', type: ['1', '3', '2', '10', '8'] },
      { answer: '짧은 갈고리모양 부리', type: ['7', '9', '11'] },
      { answer: '길고 뾰족한 부리', type: ['0', '6', '5', '4'] },
      { answer: '길고 휘어진 부리', type: ['0', '6', '5', '4'] },
      { answer: '넓적하고 큰 부리', type: ['0', '6', '5', '4'] }
    ]
  },
  {
    q: '마지막 질문입니다! 새의 주요 색상은 뭐였나요?',
    a: [
      { answer: '회색', type: ['1', '2', '4' ] },
      { answer: '흰색', type: ['7', '10', '8', '9', '11' ] },
      { answer: '노란색', type: ['0', '3', '6', '5' ] },
      { answer: '주황색', type: ['0', '3', '6', '5' ] },
      { answer: '갈색', type: ['0', '3', '6', '5' ] },
      { answer: '검은색', type: ['0', '3', '6', '5' ] },
      { answer: '파란색', type: ['0', '3', '6', '5' ] },
      { answer: '붉은색', type: ['0', '3', '6', '5' ] },
